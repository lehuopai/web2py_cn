## 组件和插件[¶](http://web2py.com/books/default/chapter/29/12/components-and-plugins#Components-and-plugins)
...
```
分贝。define_table ( 'plugin_comments_comment' , 
   Field ( 'body' ,  'text' ,  label = ' Your comment' ), 
   auth .signature )
